...
const AdminMainPage = ({setRegister, teamName, isRegisterClosed}) => {
                ...
                <Layout>
                    <Content className='system__calendar'>
                        <Row>
                            ...
                            <Col md={6} offset={12}>
                                <Row><Space size={8} align='start'><Checkbox defaultChecked={isRegisterClosed} onChange={() => updateAdminData()}></Checkbox><h5>關閉登記</h5></Space></Row>
                            </Col>
                        </Row>
